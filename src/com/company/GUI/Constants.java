...
public class Constants {
    ...
    public static final int LAF_LUNA= 2;



    // The possible look and feels
    public static final String[] LAF_NAMES = new String[]
            {"Dark Mode","Light Mode","Prototype","<html><br/>1- Press Process Zip File button and Select the submissions zip file<br/>" +
                    ...
                    "<br/>" +
                    "4- Clicking on any of the links will run the Analysis tool<br/>" +
                    " for those pairs and view similarities results" +
                    "<br/>" +
                    "<br/>" +
                    "IMPORTANT!! <br/> <br/>" +
                    "1- You need to add cppCheck as Environmental variable and <br/>" +
                    "install Strawberry perl in order to use the tool<br/><br/>" +
